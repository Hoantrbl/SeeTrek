...
directory = "/home/lipengteng/.cache/huggingface/vsibench"
mode = "normal"

# model_names = ["yolov8n", "yolov8s", "yolo11n", "yolo11s"]
# skip_frame_values = [1, 2, 3]
...
for model_name in model_names:
    for skip_frames in skip_frame_values:
        save_dir = f"./tools/SeeTrek/modified_dataset_{model_name}_2hz_every_{skip_frames}_frames"
